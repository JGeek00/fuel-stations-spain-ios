        ...
        HStack(alignment: .top) {
            ...
            VStack(alignment: .leading) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    Product(name: String(localized: "Renewable Diesel"), value: station.renewableDieselPrice)
                    ...
                    Product(name: String(localized: "Gasoline 95 E25"), value: station.gasoline95E25Price)
                    Product(name: String(localized: "Gasoline 95 E85"), value: station.gasoline95E85Price)
                    ...
                    Product(name: String(localized: "Renewable Gasoline"), value: station.renewableGasolinePrice)
                    ...
                    Product(name: String(localized: "Compressed Biogas"), value: station.compressedBiogasPrice)
                    Product(name: String(localized: "Liquefied Biogas"), value: station.liquefiedBiogasPrice)
                    Product(name: String(localized: "Hydrogen"), value: station.hydrogenPrice)
                    Product(name: String(localized: "Methanol"), value: station.methanolPrice)
                    Product(name: String("AdBlue"), value: station.adbluePrice)
                    Product(name: String("Ammonia"), value: station.ammoniaPrice)
                }
                Spacer()
                    .frame(height: 8)
